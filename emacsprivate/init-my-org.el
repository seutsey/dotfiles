...
(setq org-capture-templates
      (quote (("t" "todo" entry (file "~/Dropbox/org/refile.org")
              ...
              ("p" "PR Review" entry (file "~/Dropbox/org/refile.org")
               "* PR Review of %? :PRREVIEW:\n%U" :clock-in t :clock-resume t)
              ("s" "Chat conversation" entry (file "~/Dropbox/org/refile.org")
               "* CHAT %? :CHAT:\n%U" :clock-in t :clock-resume t)
              ("c" "Phone call" entry (file "~/Dropbox/org/refile.org")
               "* PHONE %? :PHONE:\n%U" :clock-in t :clock-resume t)
